...
return (
    <div className="bg-primary w-full h-16 fixed left-0 bottom-0 shadow-md flex space-x-8 items-center justify-center lg:hidden dark:bg-gray-600">
        ...
        <a href="https://github.com/renier1989/todo-app" target="_blank">
            ...
            height="16"
            fill="currentColor"
            className="bi bi-moon-stars-fill w-6 h-6 cursor-pointer"
            viewBox="0 0 16 16"
            >
            <path
                className="fill-current text-secondary hover:text-secondary-dark text-center "
        ...
        <a href="#" className="">
            ...
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            className="bi bi-plus-circle-fill w-11 h-11 cursor-pointer"
            viewBox="0 0 16 16"
            >
            <path
                className="fill-current text-secondary hover:text-secondary-dark text-center"
        ...
        >
            ...
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            className="bi bi-moon-stars-fill w-11 h-11 cursor-pointer"
            viewBox="0 0 16 16"
            >
            <path
        ...
        <a href="https://www.linkedin.com/in/renier-vargas-0a971b125/" target="_blank">
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-moon-stars-fill w-6 h-6 cursor-pointer bi bi-linkedin"
                viewBox="0 0 16 16"
              >
                <path 
                className="fill-current text-secondary hover:text-secondary-dark text-center "

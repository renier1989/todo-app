      ...
      <li className="flex my-3 bg-indigo-400 p-5 rounded-lg justify-center relative">
        ...
        >
          <svg
            ...
            viewBox="0 0 16 16"
          >
            <path className={`fill-current  text-green-300 hover:text-green-400 ${props.completed && 'text-gray-300 hover:text-gray-400' }`} 
        ...
        className={`text-lg font-bold text-gray-700 ${props.completed ? 'line-through' : null }`}
